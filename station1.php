	...
	<nav class="navbar">
		...
		<div class="part">
			...
			<div class="box">
				...
				<a href="book.php?station=station1&plugs=AC1" class="link_btn">Book</a>
			</div>
			<div class="box">
				<h1 class="title">
					Plug-2
				...
				<img src="res/plug.jpg"><br>
				<a href="book.php?station=station1&plugs=AC2" class="link_btn">Book</a>
			</div>
			<div class="box">
				<h1 class="title">
					Plug-3
				...
				<img src="res/plug.jpg"><br>
				<a href="book.php?station=station1&plugs=AC3" class="link_btn">Book</a>
			</div>
		</div>
		...
		<div class="part">
			...
			<div class="box">
				...
				<img src="res/plug.jpg"><br>
				<a href="book.php?station=station1&plugs=DC1" class="link_btn">Book</a>
			</div>
			<div class="box">
				<h1 class="title">
					Plug-2
				...
				<img src="res/plug.jpg"><br>
				<a href="book.php?station=station1&plugs=DC2" class="link_btn">Book</a>
			</div>
			<div class="box">
				<h1 class="title">
					Plug-3
				...
				<img src="res/plug.jpg"><br>
				<a href="book.php?station=station1&plugs=DC3" class="link_btn">Book</a>
			</div>
		</div>
	</div>
	<script>
